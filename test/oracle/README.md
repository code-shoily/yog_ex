...
| | Yen k-shortest | `Yog.Pathfinding.Yen` | `nx.shortest_simple_paths` | Exact k paths | 1 | ✅ |
...
| | Min Arborescence | `Yog.MST` | `nx.minimum_spanning_arborescence` | Exact total weight | 1 | ✅ |
...
| Metric | Value |
|--------|-------|
| Total oracle properties | **37** |
| Exact-parity properties | **33** |
| Quality-floor properties | **3** (community detection) |
...
├── mst_oracle_test.exs             # 5 properties
