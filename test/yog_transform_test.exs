defmodule YogTransformTest do
  ...
  test "transpose_cycle_test" do
    graph =
      ...
      |> Yog.add_edge(from: 3, to: 1, weight: 3)
  ...
  test "filter_nodes_complex_pruning_test" do
    graph =
      ...
      |> Yog.add_node(3, 3)
      |> Yog.add_node(4, 4)
      |> Yog.add_edge(from: 1, to: 2, weight: "a")
      |> Yog.add_edge(from: 2, to: 3, weight: "b")
      |> Yog.add_edge(from: 3, to: 4, weight: "c")
      |> Yog.add_edge(from: 1, to: 4, weight: "d")
  ...
  test "merge_disjoint_graphs_test" do
    ...
    g2 =
      ...
      |> Yog.add_node(3, "C")
      |> Yog.add_node(4, "D")
      |> Yog.add_edge(from: 3, to: 4, weight: 20)
  ...
  test "merge_overlapping_edges_test" do
    ...
    g2 =
      ...
      |> Yog.add_node(1, "A")
      |> Yog.add_node(2, "B")
      |> Yog.add_edge(from: 1, to: 2, weight: 20)
  ...
  test "merge_combines_edges_from_same_node_test" do
    ...
    g2 =
      ...
      |> Yog.add_node(4, "D")
      |> Yog.add_node(5, "E")
      |> Yog.add_edge(from: 1, to: 4, weight: 20)
      |> Yog.add_edge(from: 1, to: 5, weight: 25)
  ...
  test "transpose_preserves_edge_weights_test" do
    graph =
      ...
      |> Yog.add_node(1, "A")
      |> Yog.add_node(2, "B")
      |> Yog.add_edge(from: 1, to: 2, weight: 42)
