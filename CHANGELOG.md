...
- **`Infomap` & `Walktrap` Bug Fixes** — Fixed map equation entropy calculation in `Infomap` by incorporating `q_exit` and node entropy terms into `h_p`, and resolved a range calculation bug in `Walktrap` for random walk length $t = 1$.
- **`Yog.Community` Input & Option Validation** — Enforced consistent `%Yog.Graph{}` struct verification, `ArgumentError` exception handling, and options validation across all community detection modules (`Yog.Community`, `Louvain`, `Leiden`, `LabelPropagation`, `Walktrap`, `Infomap`, `GirvanNewman`, `CliquePercolation`, `FluidCommunities`, `LocalCommunity`, `Metrics`, `Overlapping`, `Result`, `Dendrogram`).
...
- **Pre-1.0 Module Audit & Hardening** — Completed stabilizing audit pass across core (`Yog`, `Yog.Model`, `Yog.DAG`, `Yog.DAG.Model`, `Yog.DAG.Algorithm`), traversal (`Yog.Traversal`, `Yog.Traversal.Sort`, `Yog.Traversal.Walk`, `Yog.Traversal.Implicit`), network analysis & connectivity (`Yog.Connectivity`, `Yog.Connectivity.SCC`, `Yog.Connectivity.Components`, `Yog.Connectivity.Analysis`, `Yog.Connectivity.KCore`, `Yog.Connectivity.Reachability`, `Yog.Health`, `Yog.Centrality`, `Yog.Approximate`), community detection (`Yog.Community`, `Yog.Community.Result`, `Yog.Community.Louvain`, `Yog.Community.Leiden`, `Yog.Community.LabelPropagation`, `Yog.Community.Walktrap`, `Yog.Community.Infomap`, `Yog.Community.GirvanNewman`, `Yog.Community.CliquePercolation`, `Yog.Community.FluidCommunities`, `Yog.Community.LocalCommunity`, `Yog.Community.Metrics`, `Yog.Community.Overlapping`, `Yog.Community.Dendrogram`), layout and rendering (`Yog.Layout`, `Yog.Layout.Circular`, `Yog.Layout.Random`, `Yog.Layout.Spring`, `Yog.Layout.Tutte`, `Yog.Layout.Shell`, `Yog.Layout.Multipartite`, `Yog.Render.DOT`, `Yog.Render.Mermaid`, `Yog.Render.SVG`, `Yog.Render.ASCII`, `Yog.Multi.DOT`, `Yog.Multi.Mermaid`), builders & generators (`Yog.Builder.Labeled`, `Yog.Builder.Live`, `Yog.Builder.Grid`, `Yog.Builder.GridGraph`, `Yog.Builder.Toroidal`, `Yog.Builder.ToroidalGraph`, `Yog.Generator.Classic`, `Yog.Generator.Random`, `Yog.Generator.Maze`), flow, matching & MST (`Yog.Flow.SuccessiveShortestPath`, `Yog.Flow.NetworkSimplex`, `Yog.Matching`, `Yog.Property.Bipartite`, `Yog.MST`, `Yog.MST.Kruskal`, `Yog.MST.Prim`, `Yog.MST.Boruvka`, `Yog.MST.Edmonds`, `Yog.MST.Wilson`, `Yog.MST.Result`, `Yog.MST.Utils`), graph properties (`Yog.Property`, `Yog.Property.Cyclicity`, `Yog.Property.Eulerian`, `Yog.Property.Clique`, `Yog.Property.Structure`, `Yog.Property.Planarity`, `Yog.Property.Coloring`, `Yog.Property.TreeDecomposition`, `Yog.Property.WeisfeilerLehman`), IO (`XMLUtils`, `Graph6`, `Sparse6`, `MatrixMarket`, `Matrix`, `LEDA`, `Pajek`, `GDF`, `JSON`, `GEXF.SaxyHandler`, `GEXF.Multi`, `GEXF.Common`, `GEXF`, `GraphML.Xmerl`, `GraphML.SaxyHandler`, `GraphML`), flow, transform, operation, pathfinding, and multigraph modules. Standardized error handling, updated complexity math documentation ($\mathcal{O}(\dots)$), and significantly expanded unit and property-based test coverage (#157, #158, #162, #163, #164, #181, #182, #183, #184, #190, #191, #192, #193, #194, #195, #196, #197, #198, #199, #200, #201, #202, #203, #204, #205, #206, #207, #208, #209, #210, #211, #212, #213, #214, #215, #216, #217, #218, #219, #220, #221, #222, #223, #224, #225, #226, #227, #228, #229, #230, #231, #232, #233, #234, #235, #236, #237, #238, #239, #240, #241, #242, #243, #244, #245, #246, #247, #248, #249, #250, #251, #252, #253, #254, #255, #256, #257, #258, #259, #260, #261, #262, #263, #264, #265, #266, #267, #268, #269, #271, #272, #273, #276, #277, #278, #279, #280).
