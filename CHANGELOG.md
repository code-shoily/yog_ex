...
- **Pre-1.0 Module Audit & Hardening** — Completed stabilizing audit pass across core, IO (`XMLUtils`, `Graph6`, `Sparse6`, `MatrixMarket`, `Matrix`, `LEDA`, `Pajek`, `GDF`, `JSON`, `GEXF.SaxyHandler`), flow, transform, operation, pathfinding, and multigraph modules. Standardized error handling, updated complexity math documentation ($\mathcal{O}(\dots)$), and significantly expanded unit and property-based test coverage (#268, #269, #271, #272, #273, #276, #277, #278, #279, #280).
