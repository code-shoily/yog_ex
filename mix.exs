defmodule YogEx.MixProject do
  ...
  defp elixirc_paths(:test), do: ["lib", "test/support", "test/oracle"]
  ...
  defp docs do
    [
      ...
      extras: [
        ...
        {"livebooks/guides/01_getting_started.livemd",
        ...
        {"livebooks/guides/02_traversals_and_pathfinding.livemd",
        ...
        {"livebooks/guides/04_dag_analysis.livemd",
        ...
        {"livebooks/gallery/maze_gallery.livemd",
         [filename: "maze_gallery", title: "Maze Gallery"]},
        {"livebooks/how_to/dot_complete_guide.livemd",
         [filename: "dot_complete_guide", title: "DOT Complete Guide"]},
