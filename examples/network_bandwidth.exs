defmodule NetworkBandwidth do
  ...
  def run do
    ...
    network =
      ...
      |> Yog.add_edge_ensure(from: 0, to: 2, with: 30)
      ...
      |> Yog.add_edge_ensure(from: 2, to: 3, with: 25)
      # Router B -> Router C (25 Mbps)
      |> Yog.add_edge_ensure(from: 2, to: 4, with: 20)
      # Router B -> Router D (20 Mbps)
      # To destination
      |> Yog.add_edge_ensure(from: 3, to: 5, with: 30)
      # Router C -> Destination (30 Mbps)
      |> Yog.add_edge_ensure(from: 4, to: 5, with: 15)
