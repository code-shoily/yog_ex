defmodule NetworkCableLayout do
  ...
  def run do
    buildings =
      ...
      |> Yog.add_edge_ensure(from: 1, to: 3, with: 150)
      |> Yog.add_edge_ensure(from: 2, to: 3, with: 50)
      |> Yog.add_edge_ensure(from: 2, to: 4, with: 200)
      |> Yog.add_edge_ensure(from: 3, to: 4, with: 100)
