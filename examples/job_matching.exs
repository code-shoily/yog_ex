defmodule JobMatching do
  ...
  def run do
    ...
    network =
      ...
      |> Yog.add_edge_ensure(from: 0, to: 4, with: 1)
      |> Yog.add_edge_ensure(from: 1, to: 5, with: 1)
      |> Yog.add_edge_ensure(from: 1, to: 6, with: 1)
      |> Yog.add_edge_ensure(from: 2, to: 5, with: 1)
      |> Yog.add_edge_ensure(from: 2, to: 7, with: 1)
      |> Yog.add_edge_ensure(from: 3, to: 6, with: 1)
      |> Yog.add_edge_ensure(from: 3, to: 8, with: 1)
      |> Yog.add_edge_ensure(from: 4, to: 7, with: 1)
      |> Yog.add_edge_ensure(from: 4, to: 8, with: 1)
      |> Yog.add_edge_ensure(from: 5, to: 9, with: 1)
      |> Yog.add_edge_ensure(from: 6, to: 9, with: 1)
      |> Yog.add_edge_ensure(from: 7, to: 9, with: 1)
      |> Yog.add_edge_ensure(from: 8, to: 9, with: 1)
