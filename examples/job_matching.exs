defmodule JobMatching do
  ...
  def run do
    ...
    network =
      ...
      |> Yog.add_edge(from: 0, to: 3, weight: 1)
      |> Yog.add_edge(from: 0, to: 4, weight: 1)
      |> Yog.add_edge(from: 1, to: 5, weight: 1)
      |> Yog.add_edge(from: 1, to: 6, weight: 1)
      |> Yog.add_edge(from: 2, to: 5, weight: 1)
      |> Yog.add_edge(from: 2, to: 7, weight: 1)
      ...
      |> Yog.add_edge(from: 5, to: 9, weight: 1)
      |> Yog.add_edge(from: 6, to: 9, weight: 1)
      |> Yog.add_edge(from: 7, to: 9, weight: 1)
      |> Yog.add_edge(from: 8, to: 9, weight: 1)
