...
*   [disaster_relief_supply.livemd](file:///home/mafinar/repos/elixir/yog_ex/livebooks/projects/disaster_relief_supply.livemd): Disaster relief supply network. Features max-flow capacity planning, min-cut bottleneck analysis, route failure simulation, mitigation planning, minimum-cost shipment allocation, and DOT rendering of operational logistics networks.
*   [maze_grid_lab.livemd](file:///home/mafinar/repos/elixir/yog_ex/livebooks/projects/maze_grid_lab.livemd): Maze & grid lab. Features grid graph construction, movement predicates, perfect maze generation, shortest-path solving, connected-component obstacle analysis, weighted terrain routing, toroidal wrapping maps, and Unicode ASCII rendering.
...
*   [social_network_analyzer.livemd](file:///home/mafinar/repos/elixir/yog_ex/livebooks/projects/social_network_analyzer.livemd): Social network analyzer. Features centrality analysis, community detection and modularity, density and clustering interpretation, bridge/tie discovery, ego-network exploration, and social graph visualization.
