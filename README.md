...
There is also [a similar library written in Gleam](https://hex.pm/packages/yog), which I used to learn Gleam by collecting and translating most of the algorithms I have written in Elixir over the years. 
